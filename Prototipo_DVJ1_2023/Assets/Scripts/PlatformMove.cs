...
{
    /*Variables*/
    public ButtonPlataform plataformScript; // la plataforma se movera de un punto a otro indicado por nosotros por l ocual necesito un array
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            other.gameObject.transform.SetParent(transform.GetChild(0));// Mantienen la misma posicion 
        }
    }
